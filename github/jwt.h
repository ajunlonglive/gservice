 ...
 */
JWT_EXPORT int64_t jwt_get_grant_int(jwt_t *jwt, const char *grant);
 ...
 * complex grants (e.g. an array), then use jwt_add_grants_json().
 */
JWT_EXPORT int jwt_add_grant_int(jwt_t *jwt, const char *grant, int64_t val);
 ...
 */
JWT_EXPORT int64_t jwt_get_header_int(jwt_t *jwt, const char *header);
 ...
 * complex headers (e.g. an array), then use jwt_add_headers_json().
 */
JWT_EXPORT int jwt_add_header_int(jwt_t *jwt, const char *header, int64_t val);
